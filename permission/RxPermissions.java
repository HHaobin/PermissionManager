...
import com.forsafe.fuanyun.utils.KDLog;
...
public class RxPermissions {
            ...
            public ObservableSource<Boolean> apply(Observable<Object> o) {
                return request(o, permissions)
                        ...
                        .flatMap(new Function<List<Permission>, Observable<Boolean>>() {
                            @Override
                            public Observable<Boolean> apply(List<Permission> permissions) throws
                                    Exception
                            {
    ...
    private Observable<Permission> requestImplementation(final String... permissions) {
        ...
        for (String permission : permissions) {
            KDLog.d(TAG, "Requesting permission " + permission);
    ...
    private void requestPermissionsFromFragment(String[] permissions) {
        KDLog.d(TAG, "requestPermissionsFromFragment " + TextUtils.join(", ", permissions));
